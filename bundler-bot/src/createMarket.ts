      ...
      while (true) {
        if (index1 > 10) {
          ...
          if (!sig1)
            ...
            console.log(`Vault signature: https://solscan.io/tx/${sig1}`)
            break
          }
        }
      }
      ...
      while (true) {
        if (index2 > 10) {
          ...
          if (!sig2)
            ...
            console.log(`Market signature: https://solscan.io/tx/${sig2}`)
            break
          }
        }
      }
      console.log("Market ID: ", `https://solscan.io/account/${marketAccounts.market.publicKey.toBase58()}`);
