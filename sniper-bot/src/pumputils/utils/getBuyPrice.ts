function getBuyPrice(amount: bigint, tokenData: any): bigint {
  ...
  console.log("🚀 ~ getBuyPrice ~ tokenData.virtualTokenReserves:", tokenData.virtualTokenReserves)
  console.log("🚀 ~ getBuyPrice ~ tokenData.virtualSolReserves:", tokenData.virtualSolReserves)
